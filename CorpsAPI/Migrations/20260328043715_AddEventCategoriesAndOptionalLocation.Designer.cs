...
namespace CorpsAPI.Migrations
{
    ...
    [Migration("20260328043715_AddEventCategoriesAndOptionalLocation")]
    partial class AddEventCategoriesAndOptionalLocation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CorpsAPI.Models.AppUser", b =>
                {
                    ...
                    b.Property<int>("AttendanceStrikeCount")
                        .HasColumnType("int");
                    ...
                    b.Property<DateOnly?>("DateOfLastStrike")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("CorpsAPI.Models.Booking", b =>
                {
                    ...
                    b.Property<string>("ReservedBookingAttendeeName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ReservedBookingParentGuardianName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ReservedBookingPhone")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CorpsAPI.Models.ChildMedicalCondition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CorpsAPI.Models.Event", b =>
                {
                    ...
                    b.Property<string>("EventImageImgSrc")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CorpsAPI.Models.UserMedicalCondition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
